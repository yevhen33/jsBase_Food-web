...
function calc() {
  ...
  if (localStorage.getItem('sex')) {
    //Проверка данных в LS и запись по умолчанию
  ...
  function initLocalActiv(selector, activeClass) {
    // Активный класс с данных в LS
  ...
  initLocalActiv('#gender div', 'calculating__choose-item_active');
  initLocalActiv('.calculating__choose_big div', 'calculating__choose-item_active');
  ...
  function getDynamicInfo(selector) {
    ...
    input.addEventListener('input', function () {
      if (input.value.match(/\D/g)) {
        // Проверка ввода данных регулярное выражение
...
function cards() {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_3__["getResourses"])('http://localhost:3000/menu').then(function (data) {
    data.forEach(function (_ref) {
      var img = _ref.img,
          ...
          descr = _ref.descr,
          price = _ref.price;
      // {}- деструктуризация обьекта, берем только значения
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      var formData = new FormData(form); //Берем formData превращаем в масив масивов, превращаем в обьект, а потом в json
...
function slider(_ref) {
  ...
  var indicotor = document.createElement('ol'),
      dots = [];
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2020-08-01');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("Could not fetch ".concat(url, ", status ").concat(resull.status));
